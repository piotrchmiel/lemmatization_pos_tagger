...
from src.settings import CLASSIFIERS_DIR, SUFFIX_FILE, N_ONE_LETTER, \
                        N_TWO_LETTERS, N_THREE_LETTERS, N_FOUR_LETTERS, CORPUS_DIR
...
def main():
    ...
    print("Support Vector Machine PWr Tagger      :", svc.accuracy(CORPUS_DIR, CsvReader,
                                                                   feature_extractor))
    print("Decision Tree PWr Tagger               :", decision_tree.accuracy(CORPUS_DIR, CsvReader,
                                                                             feature_extractor))
    print("Stochastic Gradient Descent PWr Tagger :", sgd.accuracy(CORPUS_DIR, CsvReader,
                                                                   feature_extractor))
    print("Logistic Regression PWr Tagger         :", logistic_regression.accuracy(CORPUS_DIR, CsvReader,
                                                                                   feature_extractor))
    print("Naive Bayes PWr Tagger                 :", naive_bayes.accuracy(CORPUS_DIR, CsvReader,
                                                                           feature_extractor))
    print("K Neighbors PWr Tagger                 :", k_neighbors.accuracy(CORPUS_DIR, CsvReader,
                                                                           feature_extractor))
    print("Neural Networks PWr Tagger             :", neural_networks.accuracy(CORPUS_DIR, CsvReader,
                                                                               feature_extractor))
